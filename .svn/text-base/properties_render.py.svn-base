...
'''
# BoolProperty(   attr="vray_multimatte",
...
'''
# BoolProperty(   attr="vray_extratex",
#                 name="ExtraTex channel",
#                 description="",
#                 default= 0)
...
# BoolProperty(   attr="vray_extratex_affect_matte_objects",
#                 name="Affect matte objects",
#                 description="",
#                 default= 1)
# BoolProperty(   attr="vray_extratex_consider_for_aa",
#                 name="Consider for AA",
#                 description="",
#                 default= 1)
# BoolProperty(   attr="vray_extratex_filtering",
#                 name="Filtering",
#                 description="",
#                 default= 1)
...
'''
  RenderChannelZDepth
'''
# BoolProperty(   attr="vray_zdepth",
#                 name="Z-depth channel",
#                 description="",
#                 default= 0)
# FloatProperty(  attr="vray_zdepth_depth_black",
#                 name="vray_zdepth_depth_black",
#                 description="",
#                 min=, max=, soft_min=, soft_max=, default=0.0)
# FloatProperty(  attr="vray_zdepth_depth_white",
#                 name="vray_zdepth_depth_white",
#                 description="",
#                 min=, max=, soft_min=, soft_max=, default=10.0)
# BoolProperty(   attr="vray_zdepth_depth_clamp",
#                 name="vray_zdepth_depth_clamp",
#                 description="",
#                 default= 1)
...
class RENDER_PT_vray_render(RenderButtonsPanel):
	...
	def draw(self, context):
		...
		colR.prop(scene, "vray_export_lock")
		colR.prop(scene, "vray_autorun")
		colR.prop(scene, "vray_debug")
